...
FEED_CONFIG = {
    "all": {
        "title": "That American Archive - Everything",
        "image": "https://i.imgur.com/tJu6enF.png",
    },
    "main": {
        "title": "That American Archive",
        "image": "https://i.imgur.com/pBFHksQ.png",
    },
    "clean": {
        "title": "That American Archive - Clean Feed",
        "image": "https://i.imgur.com/0OyWS7I.png",
    },
}
...
# WRITE FEED
# -------------------------
def write_feed(path, body, mode):
    config = FEED_CONFIG[mode]
...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0">
  <channel>
    ...
    <description>An autogenerated feed; not for public use</description>
...
def main():
    ...
    write_feed(OUTPUT_FILE_ALL, build_feed(episodes, "all"), "all")
    write_feed(OUTPUT_FILE_MAIN, build_feed(episodes, "main"), "main")
    write_feed(OUTPUT_FILE_CLEAN, build_feed(episodes, "clean"), "clean")
